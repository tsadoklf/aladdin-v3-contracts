...
contract BalancerLPGaugeGateway is ZapGatewayBase {
    ...
    constructor(address _ctr, address _gauge, bytes32 _poolId, address _logic) {
    ...
    function deposit(address _srcToken, uint256 _amountIn, uint256[] calldata _routes, uint256 _minLPOut) external payable returns (uint256) {
    ...
    /// @return The amount of Balancer LP received.
    function _joinBalancerPool(uint256 _amount, uint256 _minLPOut, bool _isCTR) internal returns (uint256) {
        ...
        _request.maxAmountsIn[0] = MAX_UINT256;
        _request.maxAmountsIn[1] = MAX_UINT256;
